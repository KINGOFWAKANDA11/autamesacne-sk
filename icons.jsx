// Lucide-style icon components (inline SVG)
const Icon = ({ children, className = "w-5 h-5", strokeWidth = 2, ...rest }) => (
  <svg
...
const FileSignature = (props) => (
  <Icon {...props}>
    ...
    <path d="M8 18h1" />
    <path d="M16 18c-2-2-4-1-4 0s2 2 4 0z" />
  </Icon>
);
...
const StarFilled = ({ className = "w-5 h-5" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
